    ...
    where TEntity : class
{
    ...
    public IIncludableDataQueryable<TEntity, IEnumerable<TProperty>, TProperty> IncludeCollection<TProperty>(
        ...
        where TProperty : class
    {
        return new EfIncludableDataQueryable<TEntity, IEnumerable<TProperty>, TProperty>(
...
public class EfIncludableDataQueryable<TEntity, TProperty> : EfIncludableDataQueryable<TEntity>,
...
public class
    EfIncludableDataQueryable<TEntity, TCollection, TProperty> : IIncludableDataQueryable<TEntity, TCollection
        , TProperty>
    where TCollection : IEnumerable<TProperty> where TEntity : class where TProperty : class
{
    ...
    {
        return new EfIncludableDataQueryable<TEntity, IEnumerable<TProperty1>, TProperty1>(
