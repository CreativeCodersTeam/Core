...
public class
    HasMaximumLengthPropertyValidationStep<T, TProperty> : SimplePropertyValidationStepBase<T, TProperty>
    where T : class
{
    private readonly int _length;

    public HasMaximumLengthPropertyValidationStep(int length) : base(
