...
public class AsyncSimpleRelayCommand : AsyncCommandBase
{
    ...
    public AsyncSimpleRelayCommand(Func<Task> execute) :
        this(execute, () => true, NullErrorHandler.Instance) { }

    public AsyncSimpleRelayCommand(Func<Task> execute, IErrorHandler errorHandler) : this(execute, () => true,
        errorHandler) { }

    public AsyncSimpleRelayCommand(Func<Task> execute, Func<bool> canExecute) : this(execute, canExecute,
