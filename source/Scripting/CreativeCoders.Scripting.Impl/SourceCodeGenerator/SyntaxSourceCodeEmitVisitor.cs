...
using CreativeCoders.Scripting.Impl.SourceCodeGenerator.Nodes;
...
namespace CreativeCoders.Scripting.Impl.SourceCodeGenerator
{
        ...
        IVisitor<SyntaxSourceCodeEmitVisitor, EmptyLineSyntaxNode>
    {
        ...
        public SyntaxSourceCodeEmitVisitor(StringBuilder output, IScript script) : base(false)
        {
        ...
        {
            sourceCode = sourceCode.Replace(Script.CodePlaceHolder, _script.SourceCode);
