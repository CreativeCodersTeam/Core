...
namespace CreativeCoders.Core
{
    ...
    {
        public static ref readonly Argument<Guid> NotEmpty(in this Argument<Guid> argument, string? message = null)
        {
        ...
        public static ref readonly ArgumentNotNull<Guid> NotEmpty(in this ArgumentNotNull<Guid> argument, string? message = null)
        {
            if (argument.Value == Guid.Empty)
            {
                throw new ArgumentException(message ?? "GUID is empty", argument.Name);
