...
namespace CreativeCoders.Core.UnitTests
{
    public class EnumerableExtensionTest
    {
        ...
        public void Distinct_MultipleKeysDuplicates_ReturnsFilteredItems(params int[][] data)
        {
            ...
            var expectedItems = data.Where(x => x[2] == 20).Select(x => new TestData {IntValue1 = x[0], IntValue3 = x[1]})
                .ToArray();
        ...
        {
            var input = data.Select(x => new TestData {IntValue1 = x[0], IntValue2 = x[1], IntValue3 = x[2]}).ToArray();
        ...
        public void Distinct_FourKeysNoDuplicates_ReturnsInput(params int[][] data)
        {
            ...
            var distinctItems = input.Distinct(x => x.IntValue1, x => x.IntValue2, x => x.IntValue3, x => x.IntValue4)
                .ToArray();
        ...
        {
            var input = data.Select(x => new TestData
                {IntValue1 = x[0], IntValue2 = x[1], IntValue3 = x[2], IntValue4 = x[3], IntValue5 = x[4]}).ToArray();

            var distinctItems = input.Distinct(x => x.IntValue1, x => x.IntValue2, x => x.IntValue3, x => x.IntValue4,
                x => x.IntValue5).ToArray();

            Assert.Equal(input, distinctItems,
                new MultiFuncEqualityComparer<TestData, int, int, int, int, int>(x => x.IntValue1, x => x.IntValue2,
        ...
        public void Distinct_ArrayKeysNoDuplicates_ReturnsInput(params int[][] data)
        {
            ...
            var distinctItems = input.Distinct<TestData, int>(x => x.IntValue1, x => x.IntValue2, x => x.IntValue3, x => x.IntValue4,
                x => x.IntValue5).ToArray();
        ...
        {
            var items = values
                .Select(x => new TestData {IntValue1 = x, IntValue2 = x, IntValue3 = x, IntValue4 = x, IntValue5 = x});

            var notDistinctItems = items.NotDistinct(x => x.IntValue1, x => x.IntValue2, x => x.IntValue3, x => x.IntValue4,
                x => x.IntValue5);
        ...
        public void NotDistinct_ArrayKeysNoDuplicates_ReturnsEmptyList(params int[] values)
        {
            ...
            var notDistinctItems = items.NotDistinct<TestData, int>(x => x.IntValue1, x => x.IntValue2, x => x.IntValue3, x => x.IntValue4,
                x => x.IntValue5);
        ...
        {
            var items = data.Where(x => x[2] == 10).Select(x => new TestData {IntValue1 = x[0], IntValue2 = x[1]});
            var expectedItems = data.Where(x => x[2] == 20).Select(x => new TestData {IntValue1 = x[0], IntValue2 = x[1]});
        ...
        [Theory]
        [InlineData(new[] {1, 2, 3, 4, 10}, new[] {1, 2, 3, 4, 10}, new[] {1, 2, 3, 5, 10}, new[] {1, 2, 3, 4, 20},
            new[] {1, 2, 3, 4, 20})]
