...
public class ValueRequestHandler : XmlRpcRequestHandlerBase
{
    ...
    {
        return this.ExecuteGenericMethod<object>(nameof(GetValueAsync), new[] {requestData.ValueType},
            requestData);
    }
    ...
    {
        return await GetValueWithExceptionHandlingAsync(() => GetValueInternalAsync<T>(requestData),
